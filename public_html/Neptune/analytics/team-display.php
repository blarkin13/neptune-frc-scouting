...
$pageTitle='Pit Match Board';$moduleName='AUGUR';$hideChrome=$tv;$bodyClass=$tv?'tv-mode':'';include dirname(__DIR__).'/partials_header.php';
?>
<?php if($tv):?><div class="tv-brand"><img src="<?=e(base_url('images/logo.png'))?>" alt="Neptune"><div><div class="muted">AUGUR · PIT MATCH BOARD</div><div style="font-size:2rem;font-weight:950">#<?=e($teamNumber)?></div></div></div><?php else:?><div class="toolbar" style="justify-content:space-between"><div><div class="module-eyebrow"><span>AUGUR</span><small>Strategy Display</small></div><h1 style="margin-bottom:4px">Pit Match Board</h1><div class="muted">Past and future matches for one of your teams. Click any robot card for full scouting and pit data.</div></div><a class="btn secondary" href="?event_id=<?=$eventId?>&team=<?=$teamNumber?>&tv=1" target="_blank"><i class="fa-solid fa-expand"></i> TV Mode</a></div><?php endif;?>
